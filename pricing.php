...
<html lang="en">
    <head>
        ...
        <title>Reyyy PS Online - AI Agency & Startup HTML Template</title>
                ...
                ?>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1500">
                        <div class="card">
                            ...
                            <h3 class="pricing"><?= $isi  ['harga'] ?> <span class="small">/per month</span></h3>
                            <hr>
                            <ul class="features">
                                <li>Gratis ongkir</li>
                                <li>Diatas 1 bulan gratis 1 minggu</li>
                                <li>Jaminan KTP</li>
                            </ul>
